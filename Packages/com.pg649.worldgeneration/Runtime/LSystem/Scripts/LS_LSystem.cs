...
using UnityEngine;
    ...
    public class LS_LSystem
    {
        ...
        public LS_LSystem(float d, short a, uint cs, uint csd, INITIAL_DIRECTION init_dir, string start, uint iterations, Dictionary<char, List<string>> rules, bool translatePointsOfList, bool printResult = false)
        {
        ...
        public static Dictionary<char, List<string>> ParseRuleInput(string[] rules)
        {
            ...
            foreach (var r in rules)
            {
                ...
                if (TERMINALS.Contains(non_terminal[0])) throw new ArgumentException("Cannot add a rule with a symbol that is a terminal: " + non_terminal[0]);
